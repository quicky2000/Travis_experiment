...
With CMake and CUDA 11.7 nvcc is not in default path so specify location of nvcc with following command to force use of gcc 10

```
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CUDA_COMPILER=/usr/local/cuda-11.7/bin/nvcc $QUICKY_REPOSITORY/my_cuda/
```
