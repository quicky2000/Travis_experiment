...
#ifndef MY_CUDA_CUDA_INFO
#define MY_CUDA_CUDA_INFO
...
{
    /**
     * Display some information about CUDA graphic cards
    ...
    int CUDA_info()
    {
        ...
        if (cudaSuccess != l_cuda_status && cudaErrorNoDevice != l_cuda_status)
        {
