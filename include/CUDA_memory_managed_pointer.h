...
#ifndef MY_CUDA_CUDA_MEMORY_MANAGED_POINTER_H
#define MY_CUDA_CUDA_MEMORY_MANAGED_POINTER_H
...
{
    /**
     * Class to be used as pointer on CUDA managed memory
...
#endif //MY_CUDA_CUDA_MEMORY_MANAGED_POINTER_H
// EOF