...
#ifndef MY_CUDA_CUDA_MEMORY_MANAGED_ARRAY_H
#define MY_CUDA_CUDA_MEMORY_MANAGED_ARRAY_H
...
namespace my_cuda
{
...
#endif // 0
    {
      public:
        ...
        /**
         * Constuctor with init value applye to all array items
...
#endif //MY_CUDA_CUDA_MEMORY_MANAGED_ARRAY_H
// EOF